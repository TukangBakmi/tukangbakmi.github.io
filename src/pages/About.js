            ...
            <div className="col-12">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">Universitas Kristen Krida Wacana • Sep 2020 - Jul 2024 • GPA: 3.85/4.00</h6>
            ...
            <div className="col-12">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">dev.cert by dev.id • Issued Feb 2025 - Expires Feb 2028</h6>
                  <p className="card-text">
            ...
            <div className="col-12">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">Indonesia Technology and Innovation • Dec 2024 - Mar 2025</h6>
                  <p className="card-text">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">PT. Maybank Indonesia Finance • Sep 2023 - Feb 2024</h6>
                  <p className="card-text">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">Universitas Kristen Krida Wacana • Mar 2023 - Jul 2023</h6>
                  <p className="card-text">
              ...
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">Bangkit Academy (Google, Tokopedia, Gojek, Traveloka) • Feb 2023 - Jul 2023</h6>
                  <p className="card-text">
